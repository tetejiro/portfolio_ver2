...
let submit = () => {
    console.log(form)
    // Tailwind のコンポーネントの値が入らないため直接取る。

    // task_start
    form.task_start = document.getElementById('task_start').textContent
    ...
    // 保存処理呼び出し
    router.post(route('MyPage.store'), form)
}
                    ...
                    <div class="container mx-auto flex flex-wrap flex-col md:flex-row items-center">
                        ...
                        <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
                            <div v-if="$page.props.auth.user.id == props.user[0].id" class="flex mr-5 hover:text-gray-900">
                                <button class="cursor-grabbing mr-5">保存</button>
                            </div>
                        </nav>
                    </div>
                </header>
                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <section class="text-gray-600 body-font">
                            <div class="container px-5 py-3 mx-auto flex flex-wrap flex-col">
                                ...
                                <!-- タブの中身 -->
                                <KeepAlive>
                                    <Task v-show="activeNum == 1" :form="form" :errors="props.errors"></Task>
                                </KeepAlive>
                                <KeepAlive>
