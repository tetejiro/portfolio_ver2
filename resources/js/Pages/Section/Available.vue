...
onMounted(() => {
  ...
  const pickerInline2_start = document.querySelector("#timepicker-inline-24-start");
  const pickerInline2_end = document.querySelector("#timepicker-inline-24-end");
