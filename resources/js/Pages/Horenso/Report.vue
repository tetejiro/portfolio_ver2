          ...
          <div class="flex flex-wrap -m-4">
            ...
            <div class="p-4 md:w-1/3">
              <div class="flex rounded-lg h-full bg-white-100 p-8 flex-col">
                ...
                <div v-if="props.errors.detail" class="text-red-600">{{ props.errors.detail }}</div>                <div class="flex-grow">
                  <p class="leading-relaxed text-base">
            ...
            <div class="px-4 md:w-1/3">
              <div class="flex rounded-lg h-full bg-white-100 p-8 flex-col">
                ...
                <div v-if="props.errors.rsvp" class="text-red-600">返信 要/不要かは必須項目です。</div>
                <div class="flex-grow">
                  <p class="leading-relaxed text-base">
