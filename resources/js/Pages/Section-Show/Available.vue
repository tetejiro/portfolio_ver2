...
<template>
    <div class="flex flex-col w-3/5 mx-auto">
      ...
      <div class="min-h-[125px] break-words whitespace-pre-wrap bg-gray-100 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">
        {{ props.form.caution }}
      </div>
    </div>
</template>