...
<template>
    <div class="flex flex-col w-3/5 mx-auto">
      ...
      <textarea
        ...
        class="break-words whitespace-pre-wrap bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">
      </textarea>
    </div>
</template>
